...
public class JavaDecisionConstructs
{
    ...
    public static void main(String[] args)
    {
        ...
        //Get the temparature from the user
        System.out.println("Please enter today's temparature in ℃:");
        temparature = Float.parseFloat(sc.nextLine());
        ...
        //Promp the user for their exam score and tell them if they've passed
        //or failed
        ...
        if (score > 40)//> = 
            ...
            System.out.printf("\nUnfortunately you have failed to meet the required"
                    + "percentage pass mark,you can still take a makeup exam so dont "
                    + "dwell on it, failure is only a minor setback!",score);
...
switch (payment) //Classic java switch...case
   {
    ...
    switch(difficulty)
    {
        ...
        case NIGHTMARE →
            System.out.println("\n"+difficulty + "\nSeriously, you didnt have to sign up for this!");    
    }
