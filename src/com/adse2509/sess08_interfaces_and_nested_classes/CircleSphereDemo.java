...
public class CircleSphereDemo
{
    ...
    //main method begins program executuion
    public static void main(String[] args)
    {
        ...
        //Prompt the user fo the radius of circle 'c2' and sphere 's2'
        System.out.println("Please enter the radius of the circle 'c2' " + 
                "in cm:\n");
        int rad1 = sc.nextInt();
        
        System.out.println("Please enter the radius of the circle 's2' " + 
                "in cm:\n");
        int rad2 = sc.nextInt();
